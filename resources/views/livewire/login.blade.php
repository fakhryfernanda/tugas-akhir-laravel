<div
    x-data="{ 'showModal': false, 'showPassword': false }"
    x-cloak
    @keydown.escape="showModal = false"
>
    <!-- Trigger for Modal -->
    <p class="p-4 bg-[#D9EDF7] text-[#36829C]">
        <span class="font-semibold">Informasi!</span> Silakan <button @click="showModal = true" class="underline font-semibold">login</button> terlebih dahulu
    </p>
    ...
    >
        <!-- Modal inner -->
        <div
            class="w-[500px] p-4 mx-auto bg-white rounded shadow-lg"
        ...
        >
            ...
            <div class="relative border-b">
                ...
                <button type="button" class="absolute top-0 right-0 z-50 cursor-pointer" @click="showModal = false">
